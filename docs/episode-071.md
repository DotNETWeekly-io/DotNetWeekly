# .NET 每周分享第 71 期
## 行业资讯
1、 [.NET 赏金项目启动](https://msrc.microsoft.com/blog/2025/07/.net-bounty-program-now-offers-up-to-40000-in-awards/)
.NET 漏洞悬赏计划迎来首次重大升级，微软宣布将最高奖励额度从 20,000 美元提升至 40,000 美元。新计划覆盖 .NET 运行时、ASP.NET Core、Entity Framework Core、Blazor、MAUI 以及与 .NET SDK 打包与供应链相关的 NuGet 官方库。研究人员可针对 RCE、逃逸、提权、绕过安全机制及供应链污染等高危漏洞提交报告。奖励金额依据漏洞严重度、影响面、报告质量和可重现性分级：关键级最高 40,000 美元，高级 20,000 美元，中级 10,000 美元。微软强调优先奖励首个有效报告，重复提交仅获部分奖励。提交路径依旧通过 MSRC 门户，需提供概念验证代码、影响分析及缓解建议。除常规的技术准则外，博客还给出了不在奖励范围内的场景，如针对过时版本、第三方库或仅影响调试构建的缺陷。新的奖励表自公布日起生效，未来将随 .NET Long-Term Support 版本同步更新。微软希望借此吸引更多安全社区力量，及早发现并修复影响全球 .NET 生态的潜在风险。
